...
file_metadata = [
    ...
    # },
    {
        "file1": "EFSA Supporting Publications - 2018 -  - Outcome of the public consultation on the draft Scientific Opinion on Listeria.pdf",
        "subject": "EFSA Supporting Publications 2018 - Outcome of the public consultation on the draft Scientific Opinion on Listeria",
        "tags": ["type:EFSA", "year:2018"]
    }
]
